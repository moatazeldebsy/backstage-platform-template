...
2. Check resource limits — JVM services need headroom for heap; check for OOMKilled: `kubectl describe pod -n services-dev -l app.kubernetes.io/name=${{ values.name }}`
