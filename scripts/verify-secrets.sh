...
echo ""
echo "┌─────────────────────────────────────────────────────────┐"
echo "│ 6. Backstage Secrets Manager entry (idp-mvp/backstage)  │"
echo "└─────────────────────────────────────────────────────────┘"
...
echo ""
echo "┌─────────────────────────────────────────────────────────┐"
echo "│ 7. AI Stack Secrets (Sprint 3/4 — bootstrap-ai.sh)      │"
echo "└─────────────────────────────────────────────────────────┘"
...
echo ""
echo "┌─────────────────────────────────────────────────────────┐"
echo "│ 8. GitHub App — Actions secrets (auto-merge CI)         │"
echo "└─────────────────────────────────────────────────────────┘"
