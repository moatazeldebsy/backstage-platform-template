...
- [Mobile Developer Guide](https://github.com/moatazeldebsy/backstage-platform-template/blob/main/backstage/catalog/docs/mobile/docs/index.md) — detailed per-platform setup and local toolchain
